...
download-models:
	if [ ! -f "Meta-Llama-3-8B.Q8_0.gguf" ]; then curl -o Meta-Llama-3-8B.Q8_0.gguf -L "https://huggingface.co/QuantFactory/Meta-Llama-3-8B-GGUF/resolve/main/Meta-Llama-3-8B.Q8_0.gguf"; else echo "Model already exists."; fi
